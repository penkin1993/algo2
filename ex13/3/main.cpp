...
Входные данные
Первая строка содержит n — число прямых (1 ≤ n ≤ 80). Каждая из следующих n строк содержит четыре целых числа x 1, y 1, x 2 и y 2 — координаты двух различных точек на очередной прямой. Координаты не превышают 100 по абсолютной величине. Прямые попарно различны.
